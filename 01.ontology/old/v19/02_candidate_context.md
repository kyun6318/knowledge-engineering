# CandidateContext v19 — 통합판

> v4 원본에 A1(ScopeType -> Seniority 변환 규칙)을 통합.
>
> 작성일: 2026-03-11 | 현재 유효 버전: **v19** | 기준: v4 CandidateContext + v4 amendments (A1) + v12 데이터 분석 v2.1
>
> **v19 변경** (2026-03-11): v18 리뷰 피드백 반영
> - [S-1] §2.3 추출 프롬프트에 라벨 간 경계 가이드를 인라인 반영 (LLM 프롬프트 실효성 확보)
> - [S-3] §2.1 "resume-hub Career 레코드 1건 = 1 Chapter" 원칙 명시, 동일 회사 연속 근무 처리 규칙 추가
> - [S-5] §3 JSON 예시에 `responsibilities` 필드 추가 (인터페이스 vs 예시 불일치 해소)
>
...
#### [v19] Career 레코드 ↔ Chapter 매핑 원칙 [S-3]
