...
>
> **v13 반영** (2026-03-10): v12 리뷰 피드백 반영 — 01~04 통합판 인라인 갱신
> - [C-1] 04_graph_schema Person 노드에 보강 속성 반영 (gender, age, career_type, freshness_weight, education_level)
> - [C-1] 04_graph_schema Industry 노드를 code-hub INDUSTRY_SUBCATEGORY 기반으로 정합
> - [C-2] 00_data_source_mapping §4.1 compute_industry_code_match() 코드 타입 혼용 수정
> - [N-1] 02_candidate_context에 Person 보강 속성, CareerDescription FK 제약, duration_months 계산, 실측 파이프라인 인라인 반영
> - [N-1] 03_mapping_features에 F1~F5 실측 ACTIVE 비율 인라인 반영
> - [N-1] 01_company_context에 code-hub INDUSTRY 참조 및 job-hub 구조화 매핑 참조 추가
>
...
| `04_graph_schema` (v13) | **[v13 완료]** Person 노드 속성 추가, Industry 노드 code-hub 정합 |
| `02_candidate_context` (v13) | **[v13 완료]** Person 보강 속성, CareerDescription FK 제약, 파이프라인 인라인 반영 |
| `03_mapping_features` (v13) | **[v13 완료]** F1~F5 예상 ACTIVE 비율 실측 기반 보정 |
