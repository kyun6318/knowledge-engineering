# CandidateContext v13 — 통합판

> v4 원본에 A1(ScopeType -> Seniority 변환 규칙)을 통합.
>
> 작성일: 2026-03-10 | 기준: v4 CandidateContext + v4 amendments (A1) + v12 데이터 분석 v2.1
>
> **v8 변경** (2026-03-08): [M-3] domain_depth에 evidence 필드 추가
>
> **v13 변경** (2026-03-10): v12 데이터 분석 v2.1 결과 인라인 반영
> - Person 보강 속성 추가 (gender, age, career_type, freshness_weight, education_level) — 00_data_source_mapping §3.5 참조
> - CareerDescription FK 부재 제약 반영 (career_id 없음 → resume 단위 귀속) — §3.2 D4
> - duration_months 계산 로직 명시 (daysWorked 100% 제로) — §3.2 D3
> - 실측 fill rate 및 데이터 품질 주석 추가
