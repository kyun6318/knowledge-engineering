...
> → 02.knowledge_graph/results/extraction_logic/v13/06_normalization.md로 이동
...
> §6 데이터 품질/coverage 실측치 → 02.knowledge_graph/results/extraction_logic/v13/07_data_quality.md로 이동

---

## 7. 정규화 선행 과제

> §7 정규화 선행 과제 → 02.knowledge_graph/results/extraction_logic/v13/06_normalization.md로 이동

---

## 8. 구현 로드맵

> §8 구현 로드맵 → 03.graphrag/results/implement_planning/separate/v3/shared/implementation_roadmap.md로 이동
...
> §10 LLM 비용 → 03.graphrag/results/implement_planning/separate/v3/shared/implementation_roadmap.md로 이동