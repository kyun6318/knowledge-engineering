...
> extract_signals() pseudo-code → 02.knowledge_graph/results/extraction_logic/v15/03_prompt_design.md 참조
...
> build_past_company_context() pseudo-code → 02.knowledge_graph/results/extraction_logic/v15/03_prompt_design.md 참조
...
> extract_role_evolution() pseudo-code → 02.knowledge_graph/results/extraction_logic/v15/03_prompt_design.md 참조

### 2.9 Context 재생성 조건

> §2.9 재생성 조건 → 03.graphrag/results/implement_planning/separate/v5/shared/regeneration_policy.md로 이동
...
> §4 GraphDB 엔티티 매핑 → 04_graph_schema.md §1-§2에 통합. Neo4j 구현 상세는 03.graphrag/results/implement_planning/separate/v5/graphrag/07_neo4j_schema.md 참조.
