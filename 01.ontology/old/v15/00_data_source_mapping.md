# 내부 데이터베이스 ↔ 온톨로지 매핑 가이드 v15

> 작성일: 2026-03-10 | 현재 유효 버전: **v15** | 기준: v11.1 + 데이터 분석 v2.1 통합
>
...
>
> <details><summary>v12~v14 변경 이력</summary>
>
...
| L5 | CompanyContext: vacancy scope_type/description | 공고 수 미정 (추정 ~100K) | ~1K tokens | Gemini 2.0 Flash | **~$10** |
