...
> 현재 유효 버전: **v18** (2026-03-10)
>
> **v18 변경** (2026-03-10): 내용 변경 없음 (버전 헤더 동기화). 본 문서는 데이터 수집 파이프라인 설계 문서로, 온톨로지 스키마와 분리된 구현 참조 문서이다. 온톨로지 설계에서 필요한 정보는 "T3/T4 소스 활성화 시 보강되는 필드와 confidence 변화"이며, 이는 `01_company_context.md §2.2`에 정의되어 있다.
>
...
>
> **[v16]** (2026-03-10): 버전 헤더 동기화 (내용 변경 없음)
>
