# CompanyContext v4 — 구현 가능 재정의

> v3 평가에서 식별된 "기업 데이터 가용성 병목"을 해결하기 위해,
> **실제 확보 가능한 데이터 소스별로 필드를 계층화**하고 추출 방법을 명시한 구현 중심 스키마.
>
> 작성일: 2026-03-08 | 기준: v3 Context Overview + v3 평가서
...
|---|---|---|
| 독립성 | 후보와 무관하게 생성 | 유지 |
| Evidence-first | 모든 claim에 근거 필수 | 유지 |
| 부분 완성 | missing_fields 명시 | 유지 |
| **데이터 소스 계층화** | — | 필드별 데이터 소스 Tier를 명시하고, Tier에 따라 confidence 상한을 제한 |
...
| T4 | 뉴스 / 기사 크롤링 | 0.55 | 미구축 | `crawl_news` |
