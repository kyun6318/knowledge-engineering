# CompanyContext v16 — 통합판

> v4 원본에 A3(CompanyTalentSignal 제외 명문화), A6(structural_tensions Taxonomy + Tier ceiling 예외)를 통합.
>
> 작성일: 2026-03-10 | 현재 유효 버전: **v16** | 기준: v4 CompanyContext + v4 amendments (A3, A6) + v12 데이터 분석 v2.1
>
...
| `vacancy` | **공고별 독립** | scope_type, seniority, team_context는 공고마다 다름 |
