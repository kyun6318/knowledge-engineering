# CandidateContext v4 — 구현 가능 재정의

> v3의 CandidateContext 개념을 유지하면서,
> **통합 Evidence 모델 적용, Graph 스키마 정합, 추출 방법 명시**를 추가한 구현 중심 스키마.
>
> 작성일: 2026-03-08 | 기준: v3 Context Overview + v3 GraphDB 엔티티 구조 + v3 평가서
