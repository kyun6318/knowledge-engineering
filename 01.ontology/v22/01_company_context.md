...
> estimate_stage() pseudo-code → 02.knowledge_graph/results/extraction_logic/v15/03_prompt_design.md 참조
...
> extract_facet() pseudo-code + 키워드 → 02.knowledge_graph/results/extraction_logic/v15/03_prompt_design.md 참조
...
> §2.4 재생성 조건 → 03.graphrag/results/implement_planning/separate/v5/shared/regeneration_policy.md로 이동
