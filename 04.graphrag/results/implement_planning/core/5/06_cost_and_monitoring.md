...
> **이 문서가 비용의 Single Source of Truth** (R2). Overview §14는 본 문서를 참조.
>
> 전체 라이프사이클 비용 통합 추정 + 모니터링 구성 + 보안 설계
>
> **v4 대비 변경**:
> - ★ v5 S1: Overview §3.4/§14의 비용 수치를 본 문서 §1.6 기준으로 통일
>
> **v3 대비 변경 (v4에서 반영 완료)**:
> - R2: 비용 Single Source of Truth 지정
> - R5: Phase 2 8주 → 9주
> - O6: $10 이하 소규모 항목은 "기타"로 통합
...
| # | v4 리뷰 권장 | v5 반영 | 문서 위치 |
|---|-------------|--------|----------|
| S1 | Overview 비용 수치 06_cost 기준 통일 | ✅ $5,563~9,208 → $5,527~9,137 | 00_overview §3.4, §14 |
| A1 | JD 파서 API 스펙 확정 확인 | ✅ 인지 사항 추가 | 04_phase3 §3-1 |
| A2 | Go/No-Go 비용 외삽 기준 | ✅ 통과 조건 추가 | 01_phase0 Go/No-Go |
| A3 | AuraDB 마이그레이션 절차 | ✅ Cypher 복사 절차 명시 | 03_phase2 §2-2 |
| A4 | Cloud Run cold start 대응 | ✅ 대안 2개 제시 | 05_phase4 §4-5 |
| U2 | mask_phones() 주석 | ✅ 토큰 형식 주의 주석 | 02_phase1 §1-B |

### v3 리뷰 반영 추적 (v4에서 반영 완료)
