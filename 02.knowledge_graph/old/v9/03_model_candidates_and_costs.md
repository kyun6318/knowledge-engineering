...
> 개정일: 2026-03-10 (v9 — v11 온톨로지 정합: 3-Tier 비교 전략 용어 통일, 전공 threshold 0.75 조정)
...
### 2.2 3-Tier 비교 전략용 Embedding **(v9 변경)**
...
> **비용 영향**: 3-Tier 비교 전략의 embedding 비용은 전체 Embedding 비용($2)의 3%에 불과. 전체 비용에 미치는 영향 무시할 수준.
...
| **A25** | 3-Tier 비교 전략 embedding similarity threshold | **스킬 0.85, 전공 0.75, 직무 0.80** **(v9 변경: 전공 0.80→0.75, v11.1 정합)** | Phase 0 PoC 50건 검증 | 높음 (정규화 정확도 직결) |
