...
> **v6**: Phase 0~2 타임라인은 v5와 동일. Phase 3이 크롤링 파이프라인으로 구체화되어 7주 일정 추가.
...
Week 11-13: Phase 1-4 (Graph 적재 + Entity Resolution + Industry 노드 + REQUIRES_ROLE + Idempotency — 2주)
Week 13-14: Phase 1-5 (MappingFeatures + MAPPED_TO + Candidate Shortlisting)

Week 14-17: Phase 2-1 (전체 데이터 처리 — 2~3주)
Week 15-16: Phase 2-2 (품질 평가 + power analysis) — 2-1과 병행
Week 16-17: Phase 2-4 (DS/MLE 서빙 인터페이스)
Week 17-19: Phase 2-3 (ML Distillation — 선택적, 점선)

Week 19-21: Phase 3 C1 (크롤러 인프라 구축 — 2주)
Week 21-23: Phase 3 C2 (T3 홈페이지 크롤링 — 2주)
Week 23-25: Phase 3 C3 (T4 뉴스 크롤링 + structural_tensions — 2주)
Week 25-26: Phase 3 C4 (데이터 병합 + 품질 검증 — 1주)
Week 26+:   Phase 3-2~3-4 (Company 관계, GraphRAG, 운영 고도화, 지속)
```

**총 MVP 완성**: ~16~19주 (Phase 0~2, ML Distillation 제외 시 ~15~17주)
**첫 동작 데모**: ~14주 (Phase 0~1 완료 시점)
**크롤링 파이프라인 완료**: ~26주 (Phase 3 C1~C4)
