...
>
> v10의 03_execution_plan.md(테스트 전략) + 05_operations_and_monitoring.md(프롬프트 관리, 증분 처리) 중
...
## 3. Organization ER 설계 보강 (v11 신규)
...
> v12 변경: A6 토큰 추정 미세 조정 (structural_tensions/work_style_signals 제외 반영)
