> 작성일: 2026-03-12
> 01.ontology/results/schema/v23/04_graph_schema.md §4-§9에서 이동.
...
| v1 채택 | **[v4] `text-embedding-005`** (Vertex AI, 768d) - GCP 네이티브, 다국어 지원. `02.knowledge_graph/v16/02_model_and_infrastructure.md`와 통일. 대안: Cohere embed-multilingual-v3.0 (1024d) |
...
> - `02.knowledge_graph/v16/01_extraction_pipeline.md`의 규모 추정(600K Person 기반)은 **v1 초기 적재 범위**(EXPERIENCED + HIGH/PREMIUM 품질) 기준이다.
