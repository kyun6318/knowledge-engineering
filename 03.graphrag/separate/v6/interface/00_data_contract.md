...
> **[v6]** operating_model 값은 float(0.0~1.0)이다. `02.knowledge_graph/v16/03_prompt_design.md`의 Pydantic 스키마와 타입 일치. 이산형 변환(HIGH/MID/LOW)은 서빙 레이어에서 수행.

> **[v6] 유효 signal 열거값** (14개 고정 taxonomy, `01.ontology/v23/02_candidate_context.md` §2.3 정의):
