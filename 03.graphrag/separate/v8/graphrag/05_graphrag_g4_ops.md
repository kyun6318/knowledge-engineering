...
> **[v3 신규] LinkedIn 증분 동기화**: Phase 5에서 BrightData 정기 크롤링 delta를 기존 증분 파이프라인(R7/R8)과 연계. LinkedIn 데이터는 resume-hub 파이프라인과 독립적으로 처리 가능.
...
> Gold Label 인건비 혹은 LLM 비용($2,920~5,840)은 전체 프로젝트 비용의 54~67%를 차지한다.
> 
