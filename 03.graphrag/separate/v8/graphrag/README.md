...
| # | 파일 | Phase | 주차 | 내용 |
|---|------|-------|------|------|
| 0 | `00_graphrag_overview.md` | — | — | Mermaid Gantt, v5 대비 기간 비교, Work/Wait, Go/No-Go, S&F 수신 포인트 |
| 1 | `01_graphrag_g0_setup.md` | G-0 | W1 | Neo4j AuraDB Free + v25 스키마 + 선행 작업 |
| 2 | `02_graphrag_g1_mvp.md` | G-1 | W5~6 | 1K 적재 코드 + Cypher 5종 + REST API + PII 미들웨어 |
| 3 | `03_graphrag_g2_scale.md` | G-2 | W10~11 | AuraDB Professional 마이그레이션(A3) + 사이징(N8) + Vector DB 선택 기준 + 벤치마크 |
| 4 | `04_graphrag_g3_matching.md` | G-3 | W17~22 | 5-피처 스코어링 + Vacancy 적재 + Organization ER + 가중치 튜닝(O3) |
| 5 | `05_graphrag_g4_ops.md` | G-4 | W24~26 | 증분 처리(R7/R8) + Gold Label(N6) + 국내 대안(E3) + Runbook + 운영 |
| 6 | `06_graphrag_cost.md` | — | — | GraphRAG 비용 SSOT (총 ~$3,427~6,777) + VG4 대비 차이 설명 |
...
> 팀 분리 리스크 및 태스크: `../interface/02_tasks.md` 참조
