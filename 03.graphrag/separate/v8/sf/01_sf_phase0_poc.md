...
> **[v3 신규] SIE 모델 PoC**: Phase 0에서 GLiNER2/NuExtract 1.5 모델의 경력기술서 구조 추출 성능을 함께 검증한다. 20건 샘플에서 LLM 단독 추출 vs SIE+LLM 하이브리드 추출의 품질을 비교한다.
> - GLiNER2: Span 기반 추출, Hallucination 없음, field별 confidence 제공
> - NuExtract 1.5: 장문/혼합 언어 처리, 초기 레이블링 보조
> 상세: `00.datamodel/model/sie-model.md`
