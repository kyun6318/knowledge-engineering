...
| 1-D-2 | Chapter + HAS_CHAPTER 관계 (G-2, v25) | DE, **G** | 그래프 적재 |
...
| 1-D-8 | Cypher 쿼리 5종 작성 (G-8, v25) | MLE, **G** | 그래프 검색 |
...
| 3-1-2 | Vacancy 노드 + 관계 적재 (v25: HAS_VACANCY 등) | DE, **G** | 그래프 적재 |
...
| ID | Task | Owner | 의존 | 비고 |
|----|------|-------|------|------|
| 5-1 | LinkedIn company_id ↔ Organization 교차 매핑 | S&F | 3-3-1 | 회사명 정규화 3차 패스 |
| 5-2 | LinkedIn experience → Chapter 보강 | S&F | 1-D-2 | AI 표준화 결과 활용 |
| 5-3 | LinkedIn seniority → scope_type 교차 검증 | S&F | 1-D-3 | confidence 보정 |

---

## 분류 집계

| 팀 | Phase 0 | Phase 1 | Phase 2 | Phase 3 | Phase 4 | Phase 5 | **합계** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **S&F (S)** | 10 | 8 | 10 | 6 | 1 | 3 | **38** |
| **GraphRAG (G)** | 1 | 7 | 4 | 7 | 10 | 0 | **29** |
| **공동 (공)** | 2 | 1 | 2 | 3 | 1 | 0 | **9** |
| **합계** | 13 | 16 | 16 | 16 | 12 | 3 | **76** |