> 작성일: 2026-03-12
> 01.ontology/results/schema/v25/00_data_source_mapping.md §8, §10에서 이동.
...
| 순서 | 과제 | 의존성 |
|------|------|--------|
| 1 | LinkedIn 회사명 ↔ resume-hub 회사명 교차 매핑 | Phase 1-4 회사명 정규화 |
| 2 | LinkedIn AI 표준화 결과 → Chapter 보강 | Phase 2-1 Person/Chapter |
| 3 | LinkedIn seniority/job_function → scope_type/Role 보강 | Phase 2-4 Role 노드 |

**LinkedIn 데이터 규모**:
- brightdata_dump_raw_stage0b: 2,019,293 프로필
- linkedin_experience_standardized: 2,695,840건 AI 표준화 경력
- 예상 추가 Organization 노드: ~200K (LinkedIn 고유 회사)
