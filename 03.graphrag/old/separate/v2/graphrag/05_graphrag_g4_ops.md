...
### v5 리뷰 E3: 국내 전문가 대안 사전 검토

> Gold Label 인건비($2,920~5,840)는 전체 프로젝트 비용의 53~64%를 차지한다.
> 리스크 상세: `../interface/02_risks.md` v5 리스크 참조

```
★ W22~23 사전 검토 (Gold Label 전문가 확보 시작):
  □ 국내 채용 도메인 전문가 활용 가능성 조사
    - 국내 전문가 비용: ~100~200만원 ($730~1,460)
    - 해외 전문가 비용: $2,920~5,840
    - 절감 효과: 최대 60%+
  □ 전문가 확보 가능 시 → 국내 대안 채택, 비용 절감분 Phase 5 확장에 활용
  □ 확보 불가 시 → 해외 전문가 원안 유지
```
