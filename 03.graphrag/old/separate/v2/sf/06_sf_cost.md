...
> VG4에서 S&F 합계 ~$2,000~2,100으로 추정한 것 대비 ~$45~145 차이. 원인:

| 항목 | VG4 추정 | separate 집계 | 차이 | 원인 |
|------|---------|-------------|------|------|
| Phase 2 인프라 | $210~360 | $134 | **$76~226** | VG4는 공동 Monitoring/Logging 비용 포함. separate는 S&F 단독분만 |
| Phase 1 기타 | ~$12 | ~$10 | **$2** | 반올림 차이 |

> 공동 인프라(Cloud Monitoring ~$10/월, Logging ~$5/월, 네트워크)는 실행 시 양 팀 균등 분배.
> **실제 총 예산은 v5 $5,527~9,137 범위 내에서 관리.** 상세: `../graphrag/06_graphrag_cost.md` 비용 검증 참조.
