...
```mermaid
gantt
    title VC3 — S&F / GraphRAG 병렬 파이프라인
    dateFormat W
    axisFormat %W주차
...
- W18: Organization ER + 한국어 특화 (계열사 사전)
...
| 전환 | 통과 조건 |
|------|---------|
| **G-1 → G-2** | 1K Person·Chapter·Skill 정상 적재, API 5종 응답, NEXT_CHAPTER 오류 0건 |
