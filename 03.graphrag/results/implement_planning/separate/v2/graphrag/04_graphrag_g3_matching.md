# GraphRAG G-3: 매칭 알고리즘 + 기업 그래프 (5.5주, W17~22)

> **v5 원본**: `04_phase3_company_and_matching.md` §3-0, §3-3, §3-4
> **트리거**: S&F 산출물 ④ (JD + CompanyContext JSONL) PubSub 수신
...
```python
# src/matching/weight_tuner.py — v4 O3: 수동 3~4 조합 비교
candidate_weights = [
